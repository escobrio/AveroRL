...
def plot_episode(observations, infos, actions, rewards):
    ...
    axs[0,0].plot(states[:,0], '.', markersize=1, color=colors[0], label=f"pos_x")
    axs[0,0].plot(states[:,1], '.', markersize=1, color=colors[1], label=f"pos_y")
    axs[0,0].plot(states[:,2], '.', markersize=1, color=colors[2], label=f"pos_z")
    ...
    axs[0,1].plot(rpy[:, 0], '.', markersize=1, color=colors[0], label=f"roll [°]")
    axs[0,1].plot(rpy[:, 1], '.', markersize=1, color=colors[1], label=f"pitch [°]")
    axs[0,1].plot(rpy[:, 2], '.', markersize=1, color=colors[2], label=f"yaw [°]")
    ...
    axs[1,0].plot(states[:, 7], '.', markersize=1, color=colors[0], label=f"lin_vel_x")
    axs[1,0].plot(states[:, 8], '.', markersize=1, color=colors[1], label=f"lin_vel_y")
    axs[1,0].plot(states[:, 9], '.', markersize=1, color=colors[2], label=f"lin_vel_z")
    ...
    axs[1,1].plot(states[:, 10], '.', markersize=1, color=colors[0], label=f"ang_vel_x")
    axs[1,1].plot(states[:, 11], '.', markersize=1, color=colors[1], label=f"ang_vel_y")
    axs[1,1].plot(states[:, 12], '.', markersize=1, color=colors[2], label=f"ang_vel_z")
    ...
    axs[2,0].plot(states[:, 13], '.', markersize=1, color=colors[0], label=f"lin_acc_x")
    axs[2,0].plot(states[:, 14], '.', markersize=1, color=colors[1], label=f"lin_acc_y")
    axs[2,0].plot(states[:, 15], '.', markersize=1, color=colors[2], label=f"lin_acc_z")
    ...
    axs[2,1].plot(states[:, 16], '.', markersize=1, color=colors[0], label=f"ang_acc_x")
    axs[2,1].plot(states[:, 17], '.', markersize=1, color=colors[1], label=f"ang_acc_y")
    axs[2,1].plot(states[:, 18], '.', markersize=1, color=colors[2], label=f"ang_acc_z")
    ...
    axs[3,0].plot(rewards, label="Reward", marker='.', linestyle='', markersize=3)
    ...
    axs[3,1].plot(observations[:, 6], '.', markersize=1, color=colors[0], label=f"g_bodyframe_x")
    axs[3,1].plot(observations[:, 7], '.', markersize=1, color=colors[1], label=f"g_bodyframe_y")
    axs[3,1].plot(observations[:, 8], '.', markersize=1, color=colors[2], label=f"g_bodyframe_z")
