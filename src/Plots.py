...
def BT_plot(observations, infos, actions, rewards):
    ...
    plt.savefig("data/eval/vel_ref_tracking.pdf", format='pdf', bbox_inches="tight")
    plt.savefig("data/eval/vel_ref_tracking.png", format='png', dpi=600, bbox_inches="tight")
